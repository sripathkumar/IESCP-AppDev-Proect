...
from database.models import db, AdRequest, All_Ad, All_Campaign, Current_Sponsor, current_Influencer

class Resources_Ad_Request(Resource):
...
class Status_Ad_request(Resource):
