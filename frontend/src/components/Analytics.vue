<template>
  <div class="analytics-container">
    <h2 class="header-title">Analytics Overview</h2>
    <div class="overview-stats">
      <div class="stat-card">
        <p>Total Sponsors</p>
        <p class="stat-value">{{ totalSponsors }}</p>
      </div>
      <div class="stat-card">
        <p>Total Influencers</p>
        <p class="stat-value">{{ totalInfluencers }}</p>
      </div>
      <div class="stat-card">
        <p>Total Campaigns</p>
        <p class="stat-value">{{ totalCampaigns }}</p>
      </div>
      <div class="stat-card">
        <p>Total Ads</p>
        <p class="stat-value">{{ totalAds }}</p>
      </div>
      <div class="stat-card">
        <p>Total Budget</p>
    ...
    <div class="charts-wrapper">
      <div class="chart-section">
        <h4 class="chart-title">Sponsor's Budget</h4>
        <canvas id="sponsorBudgetChart"></canvas>
      </div>
      <div class="chart-section">
        <h4 class="chart-title">Influencer's Reach</h4>
        <canvas id="influencerReachChart"></canvas>
      </div>
      <div class="chart-section">
        <h4 class="chart-title">Influencer Categories</h4>
        <canvas id="categoryCountChart"></canvas>
      </div>
      <div class="chart-section">
        <h4 class="chart-title">User Activity Days</h4>
      ...
      new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            ...
            backgroundColor: ['#FF6347', '#8A2BE2', '#5F9EA0', '#FF1493', '#20B2AA', '#FF4500'],
            borderColor: ['#FF6347', '#8A2BE2', '#5F9EA0', '#FF1493', '#20B2AA', '#FF4500'],
            borderWidth: 1
          }]
        },
        options: {}
